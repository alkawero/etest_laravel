...
return [
    ...
    */
    ...
    'default' => env('DB_CONNECTION', 'etest_cbt'),
    ...
    */
    ...
    'connections' => [
        ...
        'hris' => [
            ...
            'password' => env('DB_PASSWORD_HRIS', 'pahoa123'),
        ...
        'etest_cbt' => [
            ...
            'host' => env('DB_HOST', '127.0.0.1'),
            'port' => env('DB_PORT', '3306'),
            'database' => env('DB_DATABASE', 'etest_cbt_db'),
            'username' => env('DB_USERNAME', 'root'),
            'password' => env('DB_PASSWORD', 'pahoa123'),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
        ...
        'teacher_adm' => [
            ...
            'host' => env('DB_HOST', '127.0.0.1'),
            'port' => env('DB_PORT', '3306'),
            'database' => env('DB_DATABASE_ADM', 'teacher_adm'),
            'username' => env('DB_USERNAME_HRIS', 'root'),
            'password' => env('DB_PASSWORD_HRIS', 'pahoa123'),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
